...
<html>
  ...
  <head>
      ...
      <title>HotelDelLuna Staff | Check-out confirmed</title>
  ...
  <body>
    <!-- Fixed navigation bar -->
      ...
      <h1 class="page-heading">Check-out successful</h1>
      ...
      <?php
        if(isset($_POST['submit'])){
            ...
            $q = "SELECT guest.Prefix, guest.Fname, guest.Lname, booking.Adults, booking.Children, roomtype.Name, roomtype.Price, booking.DateFrom ,booking.DateTo ,payment.Method, room.RoomNo
